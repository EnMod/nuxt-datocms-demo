...
<script>
// this entire component is ripped directly from vue-flickity
// in order to use it without the beforeDestroy hook

// this prevents issues with the index's flickity instance not being preserved during transition
const Flickity = process.browser ? require("flickity") : ""
